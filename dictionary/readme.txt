...
Remote Dictionary (Using SUN RPC)
====================================
...
pandiyan@pandiyan-VirtualBox:~/Desktop/assignment/dictionary$ ./rdictionary
Commands
---------
Initialize the dictionary 	-- S
Insert words dictionary 	-- i <word> <meaning>
Lookup the words in dictionary 	-- l <word>
Delete words from dictionary 	-- d <word>
...
Command:q
program quits.
pandiyan@pandiyan-VirtualBox:~/Desktop/assignment/dictionary$
