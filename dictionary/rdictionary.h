...
typedef struct wordwithmeaning_t wordwithmeaning_t;
...
#define INSERTW 2
extern  int * insertw_1(wordwithmeaning_t *, CLIENT *);
extern  int * insertw_1_svc(wordwithmeaning_t *, struct svc_req *);
#define DELETEW 3
...
extern  bool_t xdr_wordwithmeaning_t (XDR *, wordwithmeaning_t*);

#else /* K&R C */
extern bool_t xdr_example ();
extern bool_t xdr_wordwithmeaning_t ();
